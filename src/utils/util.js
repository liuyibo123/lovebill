...
export const getSystem = () => {
    ...
    wx.getSystemInfo({
        success: function (res) {
            ...
            sys.wh = res.windowHeight * 750 / sys.ww;
...
// 网络配置
export const URL = {
    getOpenId:'http://localhost:8002/wx/getOpenId',
    getBills: 'http://localhost:8002/bill/getBillTotal',
    reg:'http://localhost:8002/user/reg'
};
